...
var wordsList = ["peter griffin", "lois griffin", "chris griffin", "stewie griffin", "meg griffin", "brian griffin", "glenn quagmire", "joe swanson", "cleveland brown", "mort goldman", "Carter Pewterschmidt", "krusty the clown", "james woods", "evil monkey", "mayor adam west", "consuela", "john herbert"];
	...
	for (var i = 0; i < arrayFromWord.length; i++) {
		if (arrayFromWord[i] === userGuess) {
			...
			if (arrayFromWord[i+1] == false) {
				var audio = new Audio("assets/audio/Roadhouse.mp3");
				audio.play();
			}
